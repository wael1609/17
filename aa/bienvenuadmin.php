...
<body>
    ...
    <main>
        ...
        <!-- Add the button to redirect to showallusers.php -->
        <section class="show-users-button">
            <a href="showallusers.php" class="button">Afficher la liste des utilisateurs</a>
        </section>
        
        <!-- Add the button to redirect to checkavis.php -->
        <section class="check-feedback-button">
            <a href="checkavis.php" class="button">Voir les avis</a>
        </section>
