...
// Check if the session variable 'userId' is set, otherwise set it to empty string
...
<head>
    ...
    <style>
        ...
        .box[href="user.php"],
        .box[href="user.php?idu=<?php echo $userId; ?>"] {
...
<body>
    ...
    <div class="container">
        <a href="user.php?idu=<?php echo $userId; ?>" class="box">
            <h2>Utilisateur</h2>
        </a>
